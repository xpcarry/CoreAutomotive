    ...
    public static class DbInitializer
    {
        ...
        public static void Seed(AppDbContext context)
        {
            ...
            if (!context.Cars.Any())
            {
                ...
                new Car { Id=3, UserId = 1, UserName="admin", DateAdded = DateTime.Now, Brand="BMV", Model="X4", ProductionYear = 2017, Mileage = "4 300 km", Engine = "1 995 cm3", FuelType= "benzyna", Power = "190 KM", Description="BMV X4 20d xDrive. SaPowerhód krajowy. SaPowerhód serwisowany. Wystawiamy fakturę VAT 23%. SaPowerhód bezwypadkowy. I właściciel.", Price = 194000M, PictureUrl="/images/bmvx4.jpg", ThumbnailUrl="/images/bmvx4.jpg"},
